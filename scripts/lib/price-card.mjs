 ...
 *
 * Extracted verbatim from audit-big.mjs's analyse() after the Pulse
 * comparisons were found to have drifted away from it. compare-pulse.mjs was
...
export function priceCard(card, comps = [], { market = UK } = {}) {
  ...
  return {
    rec,
    marketRec,
    // rawPence, not finalPence: this is what the card is WORTH, not what to
    // list it at. The floor reported £2.49 for a card whose comps said £1.44.
